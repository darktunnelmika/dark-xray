...
const exact=new Map(Object.entries({
 ...
 'کاربران':'Clients',
 'نمایندگان':'Resellers',
 'افزودن نماینده':'Add Representative',
 'مدیریت نماینده':'Manage Representative',
 'حذف نماینده':'Delete Representative',
 'نماینده جدید':'New Representative',
 'شناسه نماینده':'Representative ID',
 'رمز ورود (حداقل ۸ کاراکتر)':'Login password (minimum 8 characters)',
 'رمز جدید (خالی = بدون تغییر)':'New password (blank = unchanged)',
 'سهمیه ترافیک':'Traffic quota',
 'تعداد مشتری':'Client count',
 'Prefix مشتری':'Client prefix',
 'Prefix اجباری مشتری · خالی = آزاد':'Required client prefix · blank = unrestricted',
 'بیشترین IP هر مشتری · صفر آزاد':'Max IPs per client · 0 = unrestricted',
 'بیشترین HWID هر مشتری · صفر آزاد':'Max HWIDs per client · 0 = unrestricted',
 'Max IP / HWID هر مشتری':'Max IP / HWID per client',
 'ورود ساخته نشده':'Login missing',
 'حساب ورود، سهمیه، سیاست مشتری و اینباندهای هر نماینده از همین بخش مدیریت می‌شود.':'Manage representative login, quota, client policy, and inbounds from this page.',
 'DARK فقط یک مالک اصلی دارد. نماینده‌ها Permission Matrix جدا ندارند و دسترسی استاندارد فقط به منابع خودشان در Backend enforce می‌شود.':'DARK has one primary owner. Representatives have no separate permission matrix; standard self-scoped access is enforced by the backend.',
 'حساب ورود و Profile با هم ذخیره می‌شوند. نماینده Role یا Permission قابل انتخاب ندارد؛ دسترسی استاندارد Reseller فقط روی مشتری‌ها و منابع خودش اعمال می‌شود. غیرفعال‌کردن نماینده، Login و مشتری‌های همان نماینده را هم متوقف می‌کند.':'Login and profile are saved together. Representatives cannot choose roles or permissions; standard reseller access is limited to their own clients and resources. Disabling a representative also stops its login and clients.',
 'نماینده و حساب ورود یکپارچه ذخیره شدند.':'Representative and login were saved together.',
