...
**نسخه آزمایشی برای تست VPS:** `0.9.0-rc6`
...
بنابراین این build با برچسب **`0.9.0-rc6`** برای تست VPS منتشر می‌شود؛ Production Ready بعد از گیت‌های واقعی هدف اعلام خواهد شد.
