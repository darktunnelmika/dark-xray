...
def main():
    ...
    needed_backend=['node_agent.py','node_runtime.py','node_recovery_protocol.py','core.py','dark_policy.py','guard_bridge.py','guardd.py','reality_scan.py','smart_routing.py','smart_warp_probe.py','node_updated.py','update_bridge.py']
